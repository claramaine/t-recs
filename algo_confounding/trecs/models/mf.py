...
class ImplicitMF(BaseRecommender):
    ...
    -----------
        ...
        # thesis:new
        judgements_on: bool, default False
            Whether the model should incorporate the preference judgements vector at the end of
            each training step or not.
        
        # thesis:new
        j_strength: float, default 1.0 
            Scalar for the judgements vector, determines how strong the influence of J is
            in adjusting the predicted preferences

    Attributes
    -----------
        Inherited from BaseRecommender: :class:`~models.recommender.BaseRecommender`

        # thesis:TODO: how to write documentation for this
        judgements_on
        j_strength
    ...
    def __init__(  # pylint: disable-all
        ...
        **kwargs
        ...
        self.judgements_on = judgements_on # thesis:new
        self.j_strength = j_strength # thesis:new
    ...
    def train(self):
        ...
        if self.all_interactions.size > 0:
            ...
            # if judgements are on then we incorporate them every time the model is trained.
