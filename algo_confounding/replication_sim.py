...
class ChaneyUsers(ExtendedUsers):
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument('--output_dir', type=str, default="chaney_rep_ouput") #thesis:changed
    parser.add_argument('--seed', type=int, default=1234)
    parser.add_argument('--num_users', type=int, default=100)
    parser.add_argument('--num_items', type=int, default=10000)
    parser.add_argument('--num_attrs', type=int, default=20)
    parser.add_argument('--num_sims', type=int, default=1) # thesis:changed
    parser.add_argument('--startup_iters', type=int, default=50) #thesis:changed
    parser.add_argument('--sim_iters', type=int, default=50) #thesis:changed
    ...
    parsed_args = parser.parse_args(['--single_training']) #thesis:new, needed to make this boolean true
    ...
    for i in range(args["num_sims"]):
        ...
        for model_key in model_keys:
            ...
            if model_key != "ideal": # homogenization of similar users is always measured relative to the ideal model
